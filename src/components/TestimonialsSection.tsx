...
export function TestimonialsSection({
  ...
  return (
    ...
    >
      <div className="mx-auto flex w-full max-w-7xl flex-col items-center gap-4 text-center sm:gap-16">
        <div className="flex flex-col items-center gap-4 px-4 sm:gap-8">
          <h2 className="max-w-[720px] text-3xl font-semibold leading-tight sm:text-5xl sm:leading-tight">
            {title}
          </h2>
          <p className="max-w-[600px] text-md font-medium text-slate-600 sm:text-xl">
            {description}
          </p>
        </div>
        ...
        <div className="relative flex w-full flex-col items-center justify-center overflow-hidden">
          <div className="group flex w-full overflow-hidden p-2 [--gap:1rem] [gap:var(--gap)] flex-row [--duration:40s]">
            <div className="flex shrink-0 flex-row justify-around [gap:var(--gap)] animate-xd-marquee group-hover:[animation-play-state:paused]">
