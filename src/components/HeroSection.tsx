...
import { MdOutlineAlternateEmail, MdOutlinePhone, MdOutlinePhoneInTalk } from "react-icons/md";
        ...
        >
          ...
          {isPhoneHovered && (
            <div className="absolute bottom-full right-0 mb-3 flex items-center gap-2 rounded-full bg-white px-3 py-1 text-xs shadow-lg">
              <span className="font-medium text-slate-900 whitespace-nowrap">{phoneDisplay}</span>
              <button
                type="button"
